...
## # … with 185 more rows, and 3 more variables: bag_limit <dbl>, retrieved <dbl>,
## #   unretrieved <chr>
```
...
## # … with 15 more rows, and 3 more variables: bag_limit <dbl>, retrieved <dbl>,
## #   unretrieved <chr>
```
...
```
## # A tibble: 40 × 6
##    selected_hunterID sampled_state sp_group_estimat… open       close      error
