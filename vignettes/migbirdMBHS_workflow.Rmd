...
To demonstrate, first we will check the daily data:
...
The `hunted` function checks the "has_hunted" field in the daily or season totals data. The function takes parameters `type` and `output`. Use `type = "totals"` (default) to view a summary, `type = "state"` to view proportions by state, and `type = "species"` to view proportions by species group. Use `output = "table"` (default) to get a table from the function, or specify `type = "plot"` to get a simple ggplot2 object.
...
##  1            422536 Louisiana     Ducks            2020-09-12 2021-02-07 Early~
##  2            422536 Louisiana     Ducks            2020-09-12 2021-02-07 Early~
##  3            454023 Louisiana     Ducks            2020-09-12 2021-02-07 Early~
##  4            307419 Missouri      Geese            2020-10-03 2021-02-06 Late ~
##  5            163972 South Dakota  Geese            2020-09-05 2021-02-14 Early~
...
##  9 Tennessee     Ducks                      2 0           Saw a bunc~ 20        
## 10 California    Ducks                      7 1           5mal, 2gad~ 4         
## # ... with 35 more rows
```
