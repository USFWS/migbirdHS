...
```{r, submitted5, message = FALSE, warning = FALSE, fig.width = 7, fig.height = 5, dpi = 300, out.width = 500, fig.align = "center", echo = F}
...
```{r, bagspp1, message = FALSE, warning = FALSE, fig.width = 9, fig.height = 8, dpi = 300, out.width = 500, fig.align = "center", echo = F}
