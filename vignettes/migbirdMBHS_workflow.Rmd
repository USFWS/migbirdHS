...
##               <dbl> <chr>      <chr>                   <int>         <dbl>
## 1            409932 California Specially Regulated S…      4          -118
## 2            460936 California Specially Regulated S…      1          -118
## 3            472792 California Specially Regulated S…      1          -118
## 4           1116848 California Specially Regulated S…      2          -118
## 5           1316379 Washington Specially Regulated S…      1           -21
```
...
## ! object 'daily_records_NA' not found
```
...
## 10            308507    58944 Washington    Grays Harb… Ducks             
## # ℹ 118 more rows
...
```
## # A tibble: 49 × 6
##    selected_hunterID sampled_state sp_group_estimated           open      
##                <dbl> <chr>         <chr>                        <date>    
##  1            422536 Louisiana     Ducks                        2020-09-12
##  2            422536 Louisiana     Ducks                        2020-09-12
##  3            454023 Louisiana     Ducks                        2020-09-12
##  4            307419 Missouri      Geese                        2020-10-03
##  5            163972 South Dakota  Geese                        2020-09-05
##  6            310953 Washington    Ducks                        2020-09-26
##  7            409932 California    Specially Regulated Sea Duc… 2021-01-16
##  8            409932 California    Specially Regulated Sea Duc… 2021-01-16
##  9            409932 California    Specially Regulated Sea Duc… 2021-01-16
## 10            409932 California    Specially Regulated Sea Duc… 2021-01-16
## # ℹ 39 more rows
## # ℹ 2 more variables: close <date>, error <chr>
```
...
##  7 Missouri      Ducks                      3 0           2 hunters.  Jak…
...
```
## Error in retrievedmap(daily_records, output = "grid"): cannot open file 'C:/Users/awalter/AppData/Local/R/win-library/4.2/migbirdMBHS/R/sysdata.rdb': No such file or directory
```
