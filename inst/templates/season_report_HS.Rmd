...
How many records were finalized in the season data? (Records must also have answered "yes" to has hunted, and data are only shown if days_hunted > 0.)
...
```{r, submitted2, message = FALSE, warning = FALSE, fig.width = 7, fig.height = 4, dpi = 300, out.width = 500, fig.align = "center", echo = F}
...
How many records were finalized in the daily data? (Records must also have answered "yes" to has hunted, and data are only shown if days_hunted > 0.)
...
```{r, submitted5, message = FALSE, warning = FALSE, fig.width = 7, fig.height = 4, dpi = 300, out.width = 500, fig.align = "center", echo = F}
...
```{r, hunted2, message = FALSE, warning = FALSE, fig.width = 7, fig.height = 4, dpi = 300, out.width = 500, fig.align = "center", echo  = F}
...
```{r, hunted5, message = FALSE, warning = FALSE, fig.width = 7, fig.height = 4, dpi = 300, out.width = 500, fig.align = "center", echo  = F}
...
```{r, bagspp1, message = FALSE, warning = FALSE, fig.width = 9, fig.height = 5, dpi = 300, out.width = 500, fig.align = "center", echo = F}
...
What is the distribution of number of birds retrieved per submission group? Bubbles represent number of days hunted and red lines indicate mean values. 
