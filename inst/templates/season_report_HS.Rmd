...
datatable(
  nodata(data = get(paste0("season_totals_", as.character(params$year))), ref_data = get(paste0("all_seasons_", as.character(params$year))), species = "all"), 
...
datatable(
  nodata(data = get(paste0("daily_records_", as.character(params$year))), ref_data = get(paste0("all_seasons_", as.character(params$year))), species = "all"), 
  options = list(pageLength = 5))
```
...
knitr::kable(
  submitted(get(paste0("season_totals_", as.character(params$year)))) %>% 
...
submitted(get(paste0("season_totals_", as.character(params$year))), type = "state", output = "plot") +
...
knitr::kable(
  submitted(get(paste0("daily_records_", as.character(params$year)))) %>% 
    rename(`Has submitted?` = has_submitted) %>% 
    mutate(prop = round(n/sum(n), 2)))
```
...
submitted(get(paste0("daily_records_", as.character(params$year))), type = "state", output = "plot") +
  scale_fill_manual(values = met.brewer("Hokusai3", 2)) + 
  theme(legend.position = "bottom")
```
...
knitr::kable(
  hunted(get(paste0("season_totals_", as.character(params$year)))) %>% 
...
hunted(get(paste0("season_totals_", as.character(params$year))), type = "state", output = "plot") +
  scale_fill_manual(values = met.brewer("Hokusai3", 2)) + 
  theme(legend.position = "bottom")
```
...
hunted(get(paste0("daily_records_", as.character(params$year))), type = "state", output = "plot") +
  scale_fill_manual(values = met.brewer("Hokusai3", 2)) + 
  theme(legend.position = "bottom")
```
...
hunted(get(paste0("daily_records_", as.character(params$year))), type = "species", output = "plot") +
  scale_fill_manual(values = met.brewer("Hokusai3", 2)) + 
  theme(legend.position = "bottom")
```
...
datatable(
  partyhunt(get(paste0("daily_records_", as.character(params$year)))) %>% 
    select(-unretrieved), 
...
datatable(
  overdays(get(paste0("season_totals_", as.character(params$year))), get(paste0("all_seasons_", as.character(params$year))))
)
```
...
datatable(
  overdays(get(paste0("daily_records_", as.character(params$year))), get(paste0("all_seasons_", as.character(params$year)))) 
)
```
...
datatable(
  overbags(get(paste0("season_totals_", as.character(params$year))), get(paste0("all_seasons_", as.character(params$year)))) 
)
```
...
overbags(get(paste0("daily_records_", as.character(params$year))), get(paste0("all_seasons_", as.character(params$year)))) %>% 
  rename(
    state = sampled_state,
...
datatable(
  overbags(get(paste0("daily_records_", as.character(params$year))), get(paste0("all_seasons_", as.character(params$year))), summary = T) %>% 
    rename(
      state = sampled_state,
      sp = sp_group_estimated) %>% 
    mutate(
...
datatable(
  overbags(get(paste0("daily_records_", as.character(params$year))), get(paste0("all_seasons_", as.character(params$year))), summary = F) %>% 
    rename(
      state = sampled_state,
      sp = sp_group_estimated) %>% 
    mutate(
    ...
    mutate(over = "Y") %>% 
    bind_rows(
      overbags(get(paste0("daily_records_", as.character(params$year))), get(paste0("all_seasons_", as.character(params$year))), over = F) %>% 
        rename(
          sp = sp_group_estimated,
          state = sampled_state) %>% 
        mutate(
...
openclose(get(paste0("daily_records_", as.character(params$year))), get(paste0("all_seasons_", as.character(params$year))), summary = T) %>% 
  rename(
    sp = sp_group_estimated,
    state = sampled_state) %>% 
  left_join(
...
datatable(openclose(get(paste0("daily_records_", as.character(params$year))), get(paste0("all_seasons_", as.character(params$year))), summary = T))
```
...
retrievedmap(get(paste0("daily_records_", as.character(params$year))))
...
retrieved(get(paste0("daily_records_", as.character(params$year))), output = "plot", average = T) +
  theme(legend.position = "bottom") +
  scale_fill_manual(
    values = 
      met.brewer("Hokusai3", 
                 length(unique(get(paste0("daily_records_", as.character(params$year)))$sp_group_estimated))))

datatable(retrieved(get(paste0("daily_records_", as.character(params$year))), average = T))
```
...
bagspp(get(paste0("daily_records_", as.character(params$year))), output = "popular")
```
...
huntdays(get(paste0("daily_records_", as.character(params$year))), type = "species", output = "plot", average = T)
```
...
huntdays(get(paste0("daily_records_", as.character(params$year))), output = "plot", average = T) +
  theme(legend.position = "bottom") + 
  scale_fill_manual(
...
datatable(huntdays(get(paste0("daily_records_", as.character(params$year))), average = T))
```
...
compare(get(paste0("daily_records_", as.character(params$year))), get(paste0("season_totals_", as.character(params$year))), type = "line")
```
...
compare(get(paste0("daily_records_", as.character(params$year))), get(paste0("season_totals_", as.character(params$year))), type = "days")
```
...
compare(get(paste0("daily_records_", as.character(params$year))), get(paste0("season_totals_", as.character(params$year))), type = "retrieved")
```
